            ...
            <v-col cols="12" md="8" class="ligne">
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" md="12">
                    <h1 class="heading mb-2 grey--text">Money Status</h1>
                    <template>
                      <div id="app">
                        <GChart
                          type="ColumnChart"
                      ...
                      <v-list>
                        ...
                        <v-list-item>
                          ...
                          <v-list-item-content>
                            ...
                            <v-list-item-subtitle
                              >$2,100 left</v-list-item-subtitle
                            >
                          </v-list-item-content>
                          <v-list-item-content align="right">
                            <v-list-item-title class="indigo--text"
                            ...
                            >
                            <v-list-item-subtitle
                              >$1600 of 3,700</v-list-item-subtitle
                            >
                          </v-list-item-content> </v-list-item
                        ><v-divider inset></v-divider>
                        <v-list-item>
                          <v-list-item-avatar color="orange">
                            <v-icon dark>fas fa-dumbell</v-icon>
                          </v-list-item-avatar>
                          <v-list-item-content>
                            <v-list-item-title>Sport</v-list-item-title>
                            <v-list-item-subtitle
                              >$350 left</v-list-item-subtitle
                            >
                          </v-list-item-content>
                          <v-list-item-content align="right">
                            <v-list-item-title class="indigo--text"
                            ...
                            >
                            <v-list-item-subtitle
                              >$600 of 950</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                        <v-divider inset></v-divider>
                        <v-list-item>
                          ...
                          <v-list-item-content align="right">
                            ...
                            >
                            <v-list-item-subtitle
                              >$200 of 150</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
                ...
                <v-row>
                  ...
                  <v-col cols="12" md12>
                    <v-list-item>
                      ...
                      <v-list-item-content
                        ><v-list-item-subtitl>Heisenberg</v-list-item-subtitl>
                  ...
                  <v-col cols="12" md12>
                    <v-list-item>
                      ...
                      <v-list-item-content
                        ><v-list-item-subtitl
                          >Grat Wall wallet</v-list-item-subtitl
                        >
                        <v-list-item-title>$ 6,211</v-list-item-title>
                      </v-list-item-content>
                      <v-list-item-action>
                        <v-icon color="#073560 " large
                  ...
                  <v-col cols="12" md12>
                    <v-list-item>
                      ...
                      <v-list-item-content
                        ><v-list-item-subtitl
                          >Stone River wallet</v-list-item-subtitl
                        >
                        <v-list-item-title>$ 15,423</v-list-item-title>
                      </v-list-item-content>
                      <v-list-item-action>
                        <v-icon color="#A90166" large>fab fa-cc-paypal</v-icon>
                      </v-list-item-action>
                    </v-list-item>
                    <v-divider></v-divider>
                  </v-col>
                        ...
                        <div class="d-flex flex-no-wrap justify-space-between">
                          <div>
                            <v-card-title
                              ...
                              >Upgrade your plan to <br />GOLD</v-card-title
                            >
                            <v-card-subtitle
